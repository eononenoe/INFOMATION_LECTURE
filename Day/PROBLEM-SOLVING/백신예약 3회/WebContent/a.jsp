...
<body>
	...
	<form name="frm" action="action.jsp" method="get"
		...
		<table border="1">
			...
			<tr>
				<td>병원코드</td>
				<td><input type="radio" name="a4" value="H001">가_병원 <input type="radio" name="a4" value="H002">나_병원
					<input type="radio" name="a4" value="H003">다_병원 <input type="radio" name="a4" value="H004">라_병원</td>
			</tr>
			<tr>
				<td>예약날짜</td>
