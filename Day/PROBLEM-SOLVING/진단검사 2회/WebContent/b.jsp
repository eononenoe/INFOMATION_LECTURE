...
<body>
	...
	<form name="frm" action="action.jsp" method="get"
		...
		<table border="1">
			<tr>
				<td class="ttd">환자번호</td>
				<td><input name="b1"> 예)1001</td>
			</tr>
			<tr>
				<td class="ttd">검사코드</td>
				<td>
					<select name="b2">
			...
			<tr>
				<td class="ttd">검사시작일자</td>
				<td><input name="b3"> 예)20200101</td>
			</tr>
			<tr>
				<td class="ttd">검사상태</td>
				<td>
					<input type="radio" name="b4" value="1">검사중
					<input type="radio" name="b4" value="2">검사완료
				</td>
			</tr>
			<tr>
				<td class="ttd">검사완료일자</td>
				<td><input name="b5"> 예)20200101</td>
			</tr>
			<tr>
				<td class="ttd">검사결과</td>
				<td>
					<input type="radio" name="b6" value="X">미입력
					<input type="radio" name="b6" value="P">양성
					<input type="radio" name="b6" value="N">음성
				</td>
			</tr>
			<tr>
				<td colspan="2"  class="ttd">
					<button type="submit" onclick="return check();">검사결과등록</button>
